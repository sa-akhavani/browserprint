...
# additional attributes from fields(easy-domain list + https://panopticlick.eff.org/ + https://amiunique.org/)
add_attrs = [
...
# attributes relate to WebGL2 FP
WebGL2_attrs = [
...
# attributes relate to Real Time Connection
RTC_attrs = [
...
# attributes relate to Canvas FP
Canvas_attrs = [
    "DOMRect.height",
    "DOMRect.width",
...
# attributes relate to geolocation FP
Geo_attrs = [
...
# attributes relate to battery FP
Battery_attrs = [
...
# attributes relate to screen status
Screen_attrs = [
...
# attributes relate to network information
Network_attrs = [
...
# attributes relate to speech analyzing
Speech_attrs = [
